...
\begin{itemize}
    ...
    \item \emph{Check Deviation}. It is possible that during stochastic
          ...
          called active learning. For this work,five iterations were applied on
          the bulk
          systems with a total training data of 6080 frames.

    \item \emph{Obtain relevant system's properties}. Once the MD
          simulation is
          ...
          and $L_z$ is the total length of the box size in the direction normal to the
          surface.
